...
final class ProtocolInfo{
	...
	public const CURRENT_PROTOCOL = 2208;
	...
	public const SERVERBOUND_STONECUTTER_SET_RECIPE_PACKET = 0x162;
	public const CLIENTBOUND_STONECUTTER_SET_RECIPE_PACKET = 0x163;
